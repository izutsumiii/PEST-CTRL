                    ...
                    <?php foreach ($products as $product): ?>
                        <div class="product-card">
                            ...
                            <div class="product-actions">
                                ...
                                <button onclick="addToCart(<?php echo $product['id']; ?>)" class="btn btn-cart">Add to Cart</button>
                                <button onclick="buyNow(<?php echo $product['id']; ?>)" class="btn btn-buy">Buy Now</button>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
