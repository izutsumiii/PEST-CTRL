...
<body>
    <div class="verify-container">
        ...
        <form method="post" autocomplete="off">
            <input type="password" name="admin_code" maxlength="6" placeholder="Enter 6-digit code" required autocomplete="off" inputmode="numeric" pattern="\d{6}" autocapitalize="none" autocorrect="off" spellcheck="false">
            <br>
